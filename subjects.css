...
<head>
	...
	<title>10th Maths on GyanDaan!</title>
...
<!-- NAVIGATION -->
	<header>
		<div class="nav" id="nav">
			...
			<ul id="list-switch">
				<li><a href="#"><img src="" class="icon">JEE</a></li>
				<li><a href="gate.html"><img src="" class="icon">10th MATHS</a></li>
				<li><a href="computer_courses.html"><img src="" class="icon">SAMPLE PAPERS</a></li>
				<li><a href="computer_courses.html#data"><img src="" class="icon">10th CHEMISTRY</a></li>
				<li><a href="computer_courses.html#algo"><img src="" class="icon">COMPUTER COURSES</a></li>
				<li><a href="computer_courses.html#projects"><img src="" class="icon">10th PHYSICS</a></li>
                <li><a href="computer_courses.html#projects"><img src="" class="icon">10th BIOLOGY</a></li>
                <li><a href="computer_courses.html#projects"><img src="" class="icon">NEET</a></li>
			</ul>
...
<!-- Main Title of the Page -->
	<div class="title">
		<span>Prepare for 10th Maths on GyanDaan!</span>
		<div class="shortdesc">
			<p>Learn from GyanDaan for better scores in<br>Board Exams!</p>
		</div>
	</div>
...
<!-- Courses Available -->
	<div class="inbt">
		Accelerate your career with Math courses!
	</div>
	...
	<center>
		<div class="ccardbox">
			<div class="dcard">
				<div class="fpart"><img src="https://github.com/roshan9419/LearnEd_E-learning_Website/blob/master/images/courses/math.jpg?raw=true"></div>
	...
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="http://aptitude.brainkart.com/media/subject/article-Mathematics-999.jpg">
...
<!-- Videos on DIGITAL LOGIC Lectures -->
	...
	<div class="title2" id="digital">
		<span>Logic Maths</span>
		<div class="shortdesc2">
			<p>Learn deeply about Logic maths...</p>
		</div>
	</div>
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="https://pbs.twimg.com/profile_images/1257971876925632514/9TQjMjUW_400x400.jpg">
...
<!-- Videos on COMPUTER ORGANIZATION and ARCHITECTURE Lectures -->
	...
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="https://content.artofmanliness.com/uploads/2018/07/compound.png">
...
<!-- Videos on COMPILER Lectures -->
	...
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="https://rindx.com/wp-content/uploads/2021/11/Trigonometry-Mathematics-Tips.jpg">
...
<div class="title2" id="os">
	...
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="https://i.ytimg.com/vi/S6HFm0mwQ-k/maxresdefault.jpg">
...
<div class="title2" id="database">
	...
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="https://www.anu.edu.au/files/styles/anu_full_920_518/public/event_submission/algomaths_small.jpg?itok=Hzb2Vfjy">
...
<div class="title2" id="cn">
		<span>Mathematical Computation</span>
		<div class="shortdesc2">
			<p>Build your concepts strong easily with our great tutors...</p>
		</div>
	</div>
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="https://www.mdpi.com/img/journals/mca-logo.png?2526032ce70a9705">
...
<footer>
	<div class="footer-container">
		<div class="left-col">
			...
			<p class="rights-text">Copyright © 2021 Created By Snehal,Parth and Prasad.All Rights Reserved.</p>
			<br><p><img src="../images/icon/location.png"> PES Modern College of Engineering<br>Pune</p><br>
			<p><img src="../images/icon/phone.png"> +91-1234-567-890<br><img src="../images/icon/mail.png">&nbsp; gyandaan9419@gmail.com</p>
		</div>
		<div class="right-col">
